...
export async function generateMetadata(): Promise<Metadata> {
  ...
  // Merge contact page SEO with settings SEO
  const mergedSeo = mergeSeo(contactPage?.seo, settings?.seo);
      ...
      <div className="max-w-7xl mx-auto py-10 md:py-20 px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Get in touch with us for quotes, support, or general inquiries.
            We're here to help.
          </p>
        </div>
          ...
          <div className="bg-primary/5 rounded-lg p-8">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground mb-6">
                Fill out the form to receive pricing and lead times for our
                wireless control solutions. Our team will respond promptly with
                a customized quote based on your project requirements.
              </p>
            </div>
              ...
              <div className="flex items-start gap-3 mb-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Before requesting a quote, browse our full range of wireless
                    control solutions and find the perfect products for your
                    project.
                  </p>
