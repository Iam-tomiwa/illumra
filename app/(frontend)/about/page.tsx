...
export async function generateMetadata(): Promise<Metadata> {
  ...
  // Merge about page SEO with settings SEO
  const mergedSeo = mergeSeo(aboutPage?.seo, settings?.seo);
...
export default async function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <PagesHero backgroundImageUrl={backgroundImage}></PagesHero>
      <Separator />
